...
[![tests](https://github.com/orchestral/testbench-browser-kit/workflows/tests/badge.svg?branch=6.x)](https://github.com/orchestral/testbench-browser-kit/actions?query=workflow%3Atests+branch%3A6.x)
